    ...
    <div class="col-md-6 col-md-offset-3">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group has-feedback">
                    {!! Form::label('password_confirmation', trans('users.password_confirmation'), ['class' => 'col-md-4
                    control-label']) !!}
                    <div class="col-md-8">
                ...
                <div class="form-group">
                    <div class="col-md-offset-4 col-md-8">
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" id="agree_terms">{!! trans('message.agree_terms') !!}
                            </label>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-offset-4 col-md-8">
                        {!! Form::submit(trans('message.register'), ['id' => 'register', 'class' => 'btn btn-success'])
                        !!}
                    </div>
                </div>
                {!! Form::close() !!}
            ...
            <div class="panel-footer">
                <a id="already_registered" href="{!! route('login') !!}" class="text-center">{!!
                    trans('message.membership') !!}</a>
                <a id="terms" href=" #" class="pull-right" data-toggle="modal" data-target="#termsModal">{!!
                    trans('message.terms')
                    !!}</a>
            </div>
            @else
