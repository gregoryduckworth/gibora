    ...
    <div class="col-md-6 col-md-offset-3">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group has-feedback">
                    {!! Form::label('password_confirmation', trans('users.password_confirmation'), ['class' => 'col-md-3
                    control-label']) !!}
                    <div class="col-md-9">
                ...
                <div class="form-group">
                    <div class="col-md-offset-3 col-md-9">
                        {!! Form::submit(trans('message.passwordreset'), ['id' => 'reset_password', 'class' => 'btn
                        btn-success']) !!}
                    </div>
                </div>
                {!! Form::close() !!}
            ...
            <div class="panel-footer">
                <a id="already_registered" href="{!! route('login') !!}">{!! trans('message.membership') !!}</a>
                <a id="not_registered" href="{!! route('register') !!}" class="pull-right">{!!
                    trans('message.registermember') !!}</a>
            </div>
        </div>
    </div>
</div>
